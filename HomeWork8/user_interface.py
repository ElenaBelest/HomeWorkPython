...
action = {0: 'Создание телефонной книги',1:'Просмотр данных абонента по Фамилии', 2: 'Добавление нового абонента', 3: 'Удаление абонента', 4: 'Перезапись данных абонента ' }
